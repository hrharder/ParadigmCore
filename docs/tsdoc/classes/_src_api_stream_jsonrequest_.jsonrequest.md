[ParadigmCore](../README.md) > ["src/api/stream/JsonRequest"](../modules/_src_api_stream_jsonrequest_.md) > [JsonRequest](../classes/_src_api_stream_jsonrequest_.jsonrequest.md)
