...
▸ **checkWitness**(tx: *`SignedWitnessTx`*, state: *`IState`*): `ResponseCheckTx`

*Defined in [core/handlers/witness.ts:38](https://github.com/paradigmfoundation/paradigmcore/blob/e540330/src/core/handlers/witness.ts#L38)*
...
▸ **deliverWitness**(tx: *`SignedWitnessTx`*, state: *`IState`*): `ResponseDeliverTx`

*Defined in [core/handlers/witness.ts:56](https://github.com/paradigmfoundation/paradigmcore/blob/e540330/src/core/handlers/witness.ts#L56)*
